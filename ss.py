...
def logo_menu():
 ...
 banner = f''' 
 \x1b[38;5;46m ____  _   _    _    ____  _____ 
\x1b[38;5;46m / ___|| | | |  / \  |  _ \| ____|
\x1b[38;5;46m \___ \| |_| | / _ \ | |_) |  _|  
\x1b[38;5;46m  ___) |  _  |/ ___ \|  _ <| |___ 
\x1b[38;5;46m |____/|_| |_/_/   \_\_| \_\_____| '''
...
{P2} CURRENT DATE    : {hari}, {tanggal}''',title=f'{P2} {H2}[ {P2}USER INFORMATION {H2}]',subtitle_align='left',padding=1,style='blue'))
    ...
    if id in DARK:
        ...
        os.system("clear")
        os.system("xdg-open https://www.facebook.com/profile.php?id=61568829162256")
        time.sleep(3.0)
